...
TL;DR: 提出了一种对比多模态超图推理方法，用于解决多人3D重建中的遮挡和深度模糊问题，通过融合语义、几何和姿态线索，在群体场景中实现更准确的3D重建。


<details>
  <summary>Details</summary>
Motivation: 现有方法通常依赖单模态输入，缺乏几何指导，且往往孤立地重建个体，忽略了群体场景中的集体上下文信息，难以处理严重遮挡和深度模糊问题。

Method: 首先结合RGB特征、几何先验和遮挡感知的不完整姿态初始化节点表示；引入骨盆深度指示器作为全局空间锚点；构建共享拓扑超图以建模高阶群体动态；设计基于超图的对比学习方案，增强模态内区分性和跨模态正交性。

Result: 在Panoptic和GigaCrowd基准测试中取得了新的最先进性能。

Conclusion: 提出的对比多模态超图推理方法能够有效融合多模态信息，在严重遮挡下仍能推断缺失信息，显著提升了多人3D重建的准确性和鲁棒性。
...
### [147] [ForcingDAS: Unified and Robust Data Assimilation via Diffusion Forcing](https://arxiv.org/abs/2605.14285)
...
TL;DR: 提出ForcingDAS框架，使用带独立噪声的Diffusion Forcing学习联合轨迹先验，而非帧间转移模型，以处理非马尔可夫观测、减少误差累积，并统一滤波到平滑的推理谱


<details>
  <summary>Details</summary>
Motivation: 数据同化中的滤波方法依赖帧间转移模型，但在观测非马尔可夫（如真实天气数据）时脆弱，会累积长期误差；同时学习的方法通常分别处理滤波（实时预报）和平滑（回顾再分析），分割了本应共享的先验

Method: 基于Diffusion Forcing，为每帧分配独立噪声水平，学习联合轨迹先验而非帧间转移；通过推理调度单一模型覆盖滤波到平滑全谱（临近预报、固定滞后平滑、批再分析），无需重新训练

Result: 在2D Navier-Stokes涡量、降水临近预报和全球大气状态估计上评估，单一模型在专门化基线上有竞争力或更优，在真实天气基准上提升最大

Conclusion: ForcingDAS提供统一、鲁棒的DA框架，能捕捉长期时间依赖、减少误差累积，同一训练模型可覆盖从滤波到平滑的推理任务
...
### [148] [Denoising for Neuromorphic Cameras Based on Graph Spectral Features](https://arxiv.org/abs/2605.14734)
...
### [149] [FaSST: Fast Sparsifying Secondary Transform](https://arxiv.org/abs/2605.15086)
...
### [151] [Optimal design of solar-battery hybrid resources considering multi-market participation under weather and price uncertainty](https://arxiv.org/abs/2605.14043)
*Hikaru Hoshino,Taiyo Mantani,Eiko Furutani*

Main category: eess.SY

TL;DR: 论文提出了一种基于深度强化学习的协同优化框架，用于优化太阳能+电池混合资源的设计和电力市场投标策略。


<details>
  <summary>Details</summary>
Motivation: 随着可变可再生能源的快速增长，需要灵活高效协调的能源资源。混合资源（结合可再生能源和电池储能）参与多个电力市场增加了运营复杂性，传统优化方法难以在不确定环境下确定最优系统设计。

Method: 提出了一个深度强化学习的协同优化框架，将系统设计变量直接嵌入策略学习过程，实现混合系统容量配置和多市场投标策略的联合优化。

Result: 基于历史可再生能源发电和市场数据的案例研究表明，该框架能够有效识别考虑多市场运营的经济合理混合系统设计。

Conclusion: 该深度强化学习框架为混合太阳能-电池资源的协同优化提供了一种有效方法，能够处理可再生能源发电和市场价格的不确定性，实现系统设计和运营策略的一体化优化。
...
### [152] [Receding Horizon Multi-Agent Deceptive Path Planner](https://arxiv.org/abs/2605.14085)
...
### [153] [Frequency Nadir-Constrained Power System Restoration Planning with Energy Storage](https://arxiv.org/abs/2605.14099)
...
### [154] [JAX-Based Batched AC Power Flow for GPU Acceleration and AI Ecosystem Integration](https://arxiv.org/abs/2605.14103)
...
### [155] [Battery-Assisted Operation of Hyperscale AI Data Centers under Connect-and-Manage Interconnection Practices](https://arxiv.org/abs/2605.14105)
...
### [156] [Grid Integration of Gigawatt-Scale AI Data Centers under Connect-and-Manage](https://arxiv.org/abs/2605.14109)
*Xin Lu,Qianwen Xu*
...
### [157] [Optimizing Grid-Forming Controls using Relay-based Extremum Seeking to Enhance Transient Performance](https://arxiv.org/abs/2605.14161)
...
### [158] [Day-to-Day Traffic Network Modeling under Route-Guidance Misinformation: Endogenous Trust and Resilience in CAV Environments](https://arxiv.org/abs/2605.14204)
...
### [159] [Energy Management for Solar-Powered Electric-Bus Charging Station: A Data-Driven Method](https://arxiv.org/abs/2605.14282)
...
### [160] [Randomized Atomic Feature Models for Physics-Informed Identification of Dynamic Systems](https://arxiv.org/abs/2605.14351)
...
### [161] [Automated Curriculum Design for High-dimensional Human Motor Learning](https://arxiv.org/abs/2605.14367)
...
### [162] [Fully Dynamic Rebalancing in Dockless Bike-Sharing Systems via Deep Reinforcement Learning](https://arxiv.org/abs/2605.14501)
...
### [164] [Distributionally Robust Model Predictive Control for Virtual Power Plants](https://arxiv.org/abs/2605.14642)
...
### [165] [Flexibility-Aware Framework for Efficient Planner-Initiated Siting of Data Center](https://arxiv.org/abs/2605.14714)
...
### [166] [Addressing Terminal Constraints in Data-Driven Demand Response Scheduling](https://arxiv.org/abs/2605.14741)
...
### [167] [Hybrid Metaheuristic Optimization of Distributed Control System Hardware Architecture with Model-Based Verification](https://arxiv.org/abs/2605.14788)
*Ruslan Zakirzyanov*
...
### [168] [Robust Quadcopter Motion Control Using Output Feedback](https://arxiv.org/abs/2605.14945)
...
### [169] [On the Nonexistence of Continuous Immersions for Discrete-time Systems](https://arxiv.org/abs/2605.15161)
...
### [170] [Quantifying Cyber-Vulnerability in Power Electronics Systems via an Impedance-Based Attack Reachable Domain](https://arxiv.org/abs/2605.14502)
...
### [171] [WirelessSenseLLM: Zero-Shot Human Activity Understanding by Bridging Wireless Signals and Human Language](https://arxiv.org/abs/2605.14070)
*Mahmuda Keya,Sneh Pillai,Jiawei Yuan,Kai Zeng,Long Jiao*

Main category: cs.NI

TL;DR: 论文提出了WirelessSenseLLM，这是一个利用大语言模型从无分割Wi-Fi CSI信号中实现零样本人类运动理解的语言驱动框架，通过跨模态映射解决时序信号与离散语言之间的模态鸿沟。


<details>
  <summary>Details</summary>
Motivation: 现有CSI感知系统严重依赖精确的信号分割和预定义动作标签，限制了在零样本场景下的适用性。为了从无分割的无线信号中解释人类运动，需要解决模态不匹配和重叠动作识别等挑战。

Method: 1. 设计CSI到语言的适配器，将时序CSI特征映射到语言对齐的语义空间；2. 采用跨模态投影机制弥合CSI与语言表示之间的模态差距；3. 支持生成细粒度的自然语言描述来处理顺序和重叠的人类动作。

Result: 实验显示：零样本动作理解的准确率达92%，F1分数91%；语言推理质量提升30%（事实性）和15%（推理能力）；多人物运动解释比现有方法平均提升12.33%。

Conclusion: WirelessSenseLLM框架在无需分割训练数据的情况下，实现了从CSI信号中进行鲁棒且可解释的人类运动理解，为零样本无线感知应用提供了有效解决方案。
...
### [172] [Sub-Band Full Duplex Resource Allocation: A Predictive Deep Reinforcement Learning Approach](https://arxiv.org/abs/2605.14339)
...
### [173] [Geographic Patterns in I2P Peer Selection: An Empirical Network Topology Analysis](https://arxiv.org/abs/2605.14435)
...
### [174] [Investigating the Suitability of Delay Tolerant Networks for Broadcasting Tsunami Warnings in Palu, Indonesia](https://arxiv.org/abs/2605.15103)
...
### [175] [Vision-Based Runtime Monitoring under Varying Specifications using Semantic Latent Representations](https://arxiv.org/abs/2605.13923)
*Bardh Hoxha,Oliver Schön,Hideki Okamoto,Lars Lindemann,Georgios Fainekos*

Main category: cs.LG

TL;DR: 该研究提出了一种可认证的运行时监控方法，用于从视觉观测中监控过去时间信号时序逻辑（ptSTL），并在部分可观测性下提供有限样本保证。该方法具有可重用性：一旦训练和校准，无需针对每个公式重新训练即可认证目标片段中的任何公式。


<details>
  <summary>Details</summary>
Motivation: 在部分可观测环境下，从视觉观测中实时监控安全相关属性需要可靠的方法。现有方法通常需要针对每个监控公式进行单独训练，缺乏可重用性，且难以提供统计保证。本研究旨在开发一种可重用、可认证的监控器，能够从图像中推断安全相关量并提供有限样本保证。

Method: 针对由有限字典时态原子诱导的片段，证明了语义基础（原子鲁棒性得分向量）是单调、1-Lipschitz可重用接口中的最小预测目标。任何公式都通过从解析树导出的确定性解码器评估，单一的保形校准过程即可认证整个片段。此外，引入了滚动预测监控器，仅预测当前谓词值并在线重建时态历史；这种方法更容易学习，但在长时域上会变得保守。

Result: 在行人过马路基准测试中，滚动监控器在短时域上获得更紧密的认证边界，而语义基础监控器在长时域上比滚动方法紧致4倍。在实际Waymo驾驶数据上的验证表明，两种监控器都经验性地满足保形覆盖保证。

Conclusion: 研究提出了两种可认证的ptSTL运行时监控方法，特别是语义基础监控器在长时域上提供更优的紧致性，同时保持可重用性和统计保证，适用于自动驾驶等安全关键系统。
...
### [176] [Mechanistic Interpretability of EEG Foundation Models via Sparse Autoencoders](https://arxiv.org/abs/2605.13930)
...
TL;DR: 该研究在三种不同的EEG变压器模型上应用TopK稀疏自编码器提取稀疏特征，并通过临床分类评估特征的专一性和纠缠程度，揭示了模型内部的关键表示问题。


<details>
  <summary>Details</summary>
Motivation: EEG基础模型虽然在临床性能上达到最先进水平，但其内部计算机制不透明，这阻碍了临床信任。需要开发可解释性方法来理解这些黑盒模型的决策过程。

Method: 在SleepFM、REVE和LaBraM三种EEG变压器模型的嵌入层应用TopK稀疏自编码器提取稀疏特征字典，基于临床分类（异常、年龄、性别、药物）评估特征质量，引入概念转向和目标与非目标探测区域指标来量化操纵选择性。

Result: 发现三种操作状态：可选择性操纵的、已编码但纠缠的、未编码的。揭示了关键表示失败，包括导致全局性能崩溃的“破坏球”干预和临床概念的纠缠。光谱解码器将干预映射回振幅频谱，转化为可解释的频率特征。

Conclusion: 建立了一个可转移的诊断框架，能够发现复杂深度学习中概念表示的根本问题，并将潜在操作转化为生理可解释的信号，提高了EEG基础模型的可解释性和临床可信度。
...
### [177] [Rethinking Molecular OOD Generalization via Target-Aware Source Selection](https://arxiv.org/abs/2605.13932)
...
### [178] [Unsupervised learning of acquisition variability in structural connectomes via hybrid latent space modeling](https://arxiv.org/abs/2605.13933)
...
### [179] [Beyond Mode-Seeking RL: Trajectory-Balance Post-Training for Diffusion Language Models](https://arxiv.org/abs/2605.13935)
...
### [181] [Towards the Next Frontier of LLMs, Training on Private Data: A Cross-Domain Benchmark for Federated Fine-Tuning](https://arxiv.org/abs/2605.13936)
...
### [182] [CSI-JEPA: Towards Foundation Representations for Ubiquitous Sensing with Minimal Supervision](https://arxiv.org/abs/2605.14171)
...
### [183] [EvolveMem:Self-Evolving Memory Architecture via AutoResearch for LLM Agents](https://arxiv.org/abs/2605.13941)
...
### [184] [A Unified Geometric Framework for Weighted Contrastive Learning](https://arxiv.org/abs/2605.13943)
...
### [185] [Collider-Bench: Benchmarking AI Agents with Particle Physics Analysis Reproduction](https://arxiv.org/abs/2605.13950)
...
### [186] [WarmPrior: Straightening Flow-Matching Policies with Temporal Priors](https://arxiv.org/abs/2605.13959)
...
### [187] [Towards Resource-Efficient LLMs: End-to-End Energy Accounting of Distillation Pipelines](https://arxiv.org/abs/2605.13981)
...
### [188] [TabPFN-3: Technical Report](https://arxiv.org/abs/2605.13986)
...
### [189] [A Mutual Information Lower Bound for Multimodal Regression Active Learning](https://arxiv.org/abs/2605.14917)
...
### [190] [Neural Fields for NV-Center Inverse Sensing](https://arxiv.org/abs/2605.13988)
...
### [191] [Proposal and study of statistical features for string similarity computation and classification](https://arxiv.org/abs/2605.15110)
...
### [192] [HodgeCover: Higher-Order Topological Coverage Drives Compression of Sparse Mixture-of-Experts](https://arxiv.org/abs/2605.13997)
...
### [193] [Support Before Frequency in Discrete Diffusion](https://arxiv.org/abs/2605.13999)
...
### [194] [Dywave: Event-Aligned Dynamic Tokenization for Heterogeneous IoT Sensing Signal](https://arxiv.org/abs/2605.14014)
...
### [195] [R2R2: Robust Representation for Intensive Experience Reuse via Redundancy Reduction in Self-Predictive Learning](https://arxiv.org/abs/2605.14026)
...
### [196] [Self-Pruned Key-Value Attention: Learning When to Write by Predicting Future Utility](https://arxiv.org/abs/2605.14037)
...
### [197] [Reliability-Gated Source Anchoring for Continual Test-Time Adaptation](https://arxiv.org/abs/2605.14063)
...
### [198] [SurF: A Generative Model for Multivariate Irregular Time Series Forecasting](https://arxiv.org/abs/2605.14069)
...
### [199] [AttnGen: Attention-Guided Saliency Learning for Interpretable Genomic Sequence Classification](https://arxiv.org/abs/2605.14073)
...
### [200] [PreFT: Prefill-only finetuning for efficient inference](https://arxiv.org/abs/2605.14217)
...
### [201] [Fair and Calibrated Toxicity Detection with Robust Training and Abstention](https://arxiv.org/abs/2605.14074)
*Mokshit Surana*
...
### [202] [Action-Conditioned Risk Gating for Safety-Critical Control under Partial Observability](https://arxiv.org/abs/2605.14246)
...
### [203] [Rethinking Layer Relevance in Large Language Models Beyond Cosine Similarity](https://arxiv.org/abs/2605.14075)
...
### [205] [Mini-JEPA Foundation Model Fleet Enables Agentic Hydrologic Intelligence](https://arxiv.org/abs/2605.14120)
*Mashrekur Rahman*
...
### [206] [Reinforcement Learning for Tool-Calling Agents in Fast Healthcare Interoperability Resources (FHIR)](https://arxiv.org/abs/2605.14126)
...
### [207] [bde: A Python Package for Bayesian Deep Ensembles via MILE](https://arxiv.org/abs/2605.14146)
...
### [208] [Uncovering Trajectory and Topological Signatures in Multimodal Pediatric Sleep Embeddings](https://arxiv.org/abs/2605.14156)
*Scott Ye,Harlin Lee*
...
### [210] [LLMs Know When They Know, but Do Not Act on It: A Metacognitive Harness for Test-time Scaling](https://arxiv.org/abs/2605.14186)
...
### [211] [How to Scale Mixture-of-Experts: From muP to the Maximally Scale-Stable Parameterization](https://arxiv.org/abs/2605.14200)
...
### [212] [Towards Fine-Grained and Verifiable Concept Bottleneck Models](https://arxiv.org/abs/2605.14210)
...
### [213] [Diagnosing Training Inference Mismatch in LLM Reinforcement Learning](https://arxiv.org/abs/2605.14220)
...
### [214] [DT-Transformer: A Foundation Model for Disease Trajectory Prediction on a Real-world Health System](https://arxiv.org/abs/2605.14227)
...
### [215] [AudioMosaic: Contrastive Masked Audio Representation Learning](https://arxiv.org/abs/2605.14231)
...
### [216] [Quantum Advantage in Multi Agent Reinforcement Learning](https://arxiv.org/abs/2605.14235)
...
### [217] [Active Learners as Efficient PRP Rerankers](https://arxiv.org/abs/2605.14236)
...
### [218] [Paraphrasing Attack Resilience of Various AI-Generated Text Detection Methods](https://arxiv.org/abs/2605.14240)
...
### [219] [Latency-Quality Routing for Functionally Equivalent Tools in LLM Agents](https://arxiv.org/abs/2605.14241)
...
### [220] [Artificial Intelligence-Assistant Cardiotocography: Unified Model for Signal Reconstruction, Fetal Heart Rate Analysis, and Variability Assessment](https://arxiv.org/abs/2605.14242)
...
### [221] [Not All Timesteps Matter Equally: Selective Alignment Knowledge Distillation for Spiking Neural Networks](https://arxiv.org/abs/2605.14252)
...
### [222] [Architecture-Aware Explanation Auditing for Industrial Visual Inspection](https://arxiv.org/abs/2605.14255)
...
### [223] [Dynamics of the Transformer Residual Stream: Coupling Spectral Geometry to Network Topology](https://arxiv.org/abs/2605.14258)
...
### [224] [TILT: Target-induced loss tilting under covariate shift](https://arxiv.org/abs/2605.14280)
...
### [225] [Smooth Multi-Policy Causal Effect Estimation in Longitudinal Settings](https://arxiv.org/abs/2605.14284)
...
### [226] [MetaMoE: Diversity-Aware Proxy Selection for Privacy-Preserving Mixture-of-Experts Unification](https://arxiv.org/abs/2605.14289)
...
### [228] [Policy Optimization in Hybrid Discrete-Continuous Action Spaces via Mixed Gradients](https://arxiv.org/abs/2605.14297)
...
### [229] [Language-Induced Priors for Domain Adaptation](https://arxiv.org/abs/2605.14301)
...
### [232] [Guided Diffusion Sampling for Precipitation Forecast Interventions](https://arxiv.org/abs/2605.14317)
...
### [233] [Dynamic Latent Routing](https://arxiv.org/abs/2605.14323)
...
### [234] [AIM-DDI: A Model-Agnostic Multimodal Integration Module for Drug-Drug Interaction Prediction](https://arxiv.org/abs/2605.14327)
...
### [235] [Nearest-Neighbor Radii under Dependent Sampling](https://arxiv.org/abs/2605.14343)
...
### [236] [Exemplar Partitioning for Mechanistic Interpretability](https://arxiv.org/abs/2605.14347)
*Jessica Rumbelow*
...
### [237] [Distributionally Robust Multi-Task Reinforcement Learning via Adaptive Task Sampling](https://arxiv.org/abs/2605.14350)
...
### [238] [RQ-MoE: Residual Quantization via Mixture of Experts for Efficient Input-Dependent Vector Compression](https://arxiv.org/abs/2605.14359)
...
### [239] [MoRe: Modular Representations for Principled Continual Representation Learning on Squantial Data](https://arxiv.org/abs/2605.14364)
...
### [240] [LoMETab: Beyond Rank-1 Ensembles for Tabular Deep Learning](https://arxiv.org/abs/2605.14365)
...
### [241] [Turning Stale Gradients into Stable Gradients: Coherent Coordinate Descent with Implicit Landscape Smoothing for Lightweight Zeroth-Order Optimization](https://arxiv.org/abs/2605.14373)
...
### [242] [Optimal Pattern Detection Tree for Symbolic Rule-Based Classification](https://arxiv.org/abs/2605.14374)
...
### [243] [Data-Augmented Game Starts for Accelerating Self-Play Exploration in Imperfect Information Games](https://arxiv.org/abs/2605.14379)
...
### [244] [NodeSynth: Socially Aligned Synthetic Data for AI Evaluation](https://arxiv.org/abs/2605.14381)
...
### [245] [Watch your neighbors: Training statistically accurate chaotic systems with local phase space information](https://arxiv.org/abs/2605.14405)
...
### [246] [GeoViSTA: Geospatial Vision-Tabular Transformer for Multimodal Environment Representation](https://arxiv.org/abs/2605.14406)
...
### [247] [MahaVar: OOD Detection via Class-wise Mahalanobis Distance Variance under Neural Collapse](https://arxiv.org/abs/2605.14413)
...
### [248] [What if Tomorrow is the World Cup Final? Counterfactual Time Series Forecasting with Textual Conditions](https://arxiv.org/abs/2605.14422)
...
### [249] [Collaborative Yet Personalized Policy Training: Single-Timescale Federated Actor-Critic](https://arxiv.org/abs/2605.14423)
...
### [250] [FrontierSmith: Synthesizing Open-Ended Coding Problems at Scale](https://arxiv.org/abs/2605.14445)
...
### [251] [When Answers Stray from Questions: Hallucination Detection via Question-Answer Orthogonal Decomposition](https://arxiv.org/abs/2605.14449)
...
### [252] [LiSA: Lifelong Safety Adaptation via Conservative Policy Induction](https://arxiv.org/abs/2605.14454)
...
### [253] [Focused PU learning from imbalanced data](https://arxiv.org/abs/2605.14467)
...
### [254] [Test-Time Learning with an Evolving Library](https://arxiv.org/abs/2605.14477)
...
### [255] [ROAD: Adaptive Data Mixing for Offline-to-Online Reinforcement Learning via Bi-Level Optimization](https://arxiv.org/abs/2605.14497)
...
### [256] [Enjoy Your Layer Normalization with the Computational Efficiency of RMSNorm](https://arxiv.org/abs/2605.14521)
...
### [257] [Lang2MLIP: End-to-End Language-to-Machine Learning Interatomic Potential Development with Autonomous Agentic Workflows](https://arxiv.org/abs/2605.14527)
...
### [258] [Exploring Geographic Relative Space in Large Language Models through Activation Patching](https://arxiv.org/abs/2605.14535)
...
### [259] [RxEval: A Prescription-Level Benchmark for Evaluating LLM Medication Recommendation](https://arxiv.org/abs/2605.14543)
...
### [260] [Discovering Physical Directions in Weight Space: Composing Neural PDE Experts](https://arxiv.org/abs/2605.14546)
...
### [261] [Multi-Dimensional Model Integrity and Responsibility Assessment Index and Scoring Framework](https://arxiv.org/abs/2605.14550)
...
### [262] [SeesawNet: Towards Non-stationary Time Series Forecasting with Balanced Modeling of Common and Specific Dependencies](https://arxiv.org/abs/2605.14551)
...
### [263] [Efficient Multi-objective Prompt Optimization via Pure-exploration Bandits](https://arxiv.org/abs/2605.14553)
...
### [264] [Resolving Action Bottleneck: Agentic Reinforcement Learning Informed by Token-Level Energy](https://arxiv.org/abs/2605.14558)
...
### [265] [Woodelf++: A Fast and Unified Partial Dependence Plot Algorithm for Decision Tree Ensembles](https://arxiv.org/abs/2605.14578)
...
### [266] [Angel or Demon: Investigating the Plasticity Interventions' Impact on Backdoor Threats in Deep Reinforcement Learning](https://arxiv.org/abs/2605.14587)
...
### [267] [Silent Collapse in Recursive Learning Systems](https://arxiv.org/abs/2605.14588)
*Zhipeng Zhang*
...
### [298] [Learning with Shallow Neural Networks on Cluster-Structured Features](https://arxiv.org/abs/2605.14927)
...
### [299] [A Hardware-Aware, Per-Layer Methodology for Post-Training Quantization of Large Language Models](https://arxiv.org/abs/2605.14929)
*Earl Killian*
...
### [300] [Slot-MPC: Goal-Conditioned Model Predictive Control with Object-Centric Representations](https://arxiv.org/abs/2605.14937)
...
### [301] [Octopus: History-Free Gradient Orthogonalization for Continual Learning in Multimodal Large Language Models](https://arxiv.org/abs/2605.14938)
...
### [302] [Not All Symbols Are Equal: Importance-Aware Constellation Design for Semantic Communication](https://arxiv.org/abs/2605.14940)
...
### [303] [Efficient Online Conformal Selection with Limited Feedback](https://arxiv.org/abs/2605.14953)
...
### [304] [InfoSFT: Learn More and Forget Less with Information-Aware Token Weighting](https://arxiv.org/abs/2605.14967)
...
### [305] [Distance-Matrix Wasserstein Statistics for Scalable Gromov--Wasserstein Learning](https://arxiv.org/abs/2605.14981)
*Ao Xu,Tieru Wu*
...
### [306] [Second-Order Actor-Critic Methods for Discounted MDPs via Policy Hessian Decomposition](https://arxiv.org/abs/2605.14982)
...
### [307] [DeepTokenEEG Enhancing Mild Cognitive Impairment and Alzheimers Classification via Tokenized EEG Features](https://arxiv.org/abs/2605.15009)
...
### [308] [Boosting Reinforcement Learning with Verifiable Rewards via Randomly Selected Few-Shot Guidance](https://arxiv.org/abs/2605.15012)
...
### [319] [Forgetting That Sticks: Quantization-Permanent Unlearning via Circuit Attribution](https://arxiv.org/abs/2605.15138)
...
### [320] [Widening the Gap: Exploiting LLM Quantization via Outlier Injection](https://arxiv.org/abs/2605.15152)
...
### [321] [Self-Distilled Agentic Reinforcement Learning](https://arxiv.org/abs/2605.15155)
...
### [322] [Position: Behavioural Assurance Cannot Verify the Safety Claims Governance Now Demands](https://arxiv.org/abs/2605.15164)
...
### [323] [Eradicating Negative Transfer in Multi-Physics Foundation Models via Sparse Mixture-of-Experts Routing](https://arxiv.org/abs/2605.15179)
...
### [324] [When Are Two Networks the Same? Tensor Similarity for Mechanistic Interpretability](https://arxiv.org/abs/2605.15183)
...
### [325] [FutureSim: Replaying World Events to Evaluate Adaptive Agents](https://arxiv.org/abs/2605.15188)
...
### [326] [Function-Correction with Optimal Data Protection for the General Hamming Code Membership](https://arxiv.org/abs/2605.14023)
*Adityawardhan Yadava,Anjana A. Mahesh,Swaraj Sharma Durgi*

Main category: cs.IT

TL;DR: 本文研究了针对[2^n-1, 2^n-1-n, 3]-汉明码成员函数(一般n≥2)的单纠错函数校正码，建立了有效奇偶性分配的充要条件，利用距离-3码字图的连通二分结构构造了具有最大最小距离2的系统SEFCC，并通过将距离-2码字对最小化问题约简为最大割问题，建立了最优奇偶分配与本特布尔函数的精确联系。


<details>
  <summary>Details</summary>
Motivation: 研究针对汉明码成员函数的单纠错函数校正码设计，旨在开发具有最大最小距离的编码方案，并探索布尔函数理论在编码设计中的应用。

Method: 通过建立距离-3码字图的连通二分结构，将距离-2码字对最小化问题转化为最大割问题，利用图的特征向量获得最优奇偶分配，进一步转化为沃尔什系数的优化问题。

Result: 对于偶数n，推导出了紧下界，证明本特布尔函数可达到该界，从而建立了最优SEFCC设计与本特布尔函数之间的精确联系。

Conclusion: 本文为汉明码成员函数的SEFCC设计提供了系统框架，揭示了最优编码方案与本特布尔函数之间的深层理论联系，为函数校正码设计提供了新思路。
...
### [327] [Multiple-Bases Belief Propagation List Decoding for Quantum LDPC Codes](https://arxiv.org/abs/2605.14170)
*Sheida Rabeti,Hessam Mahdavifar*

Main category: cs.IT

TL;DR: 提出一种基于置信传播的量子低密度奇偶校验码解码器MBBP-LD，通过构建多个奇偶校验表示并行解码，以提升解码性能并保持线性时间复杂度


<details>
  <summary>Details</summary>
Motivation: 现有BP解码器在量子LDPC码解码中存在性能不足，需要开发一种能提升解码成功率高且保持低计算复杂度的新方法

Method: 利用Tanner图的无环子树分解构建多个冗余奇偶校验表示，形成结构化解码多样性，并行运行多个BP解码过程，扩展经典MBBP框架至量子场景

Result: MBBP-LD相比BP-OSD和BPGD在多个量子LDPC码上显著降低误码率（最多减少30%），所需总BP迭代次数更少，且保持类似BP的解码延迟

Conclusion: 所提出的MBBP-LD解码器在提升量子LDPC码解码性能方面表现出色，为量子纠错中高效解码提供了有前景的解决方案
...
### [328] [Univariate Bicycle Quantum LDPC Codes: Explicit Logical Structure and Distance Bounds](https://arxiv.org/abs/2605.14173)
*Sheida Rabeti,Hessam Mahdavifar*
...
### [329] [Joint Transmit and Receive Antenna Orientation Design for Secure MIMO Communications](https://arxiv.org/abs/2605.14272)
...
### [330] [Capacity Characterization and Formation Optimization for Multi-User MIMO Communications with UAV Swarm](https://arxiv.org/abs/2605.14298)
*Yong Zeng*
...
### [331] [Secure Joint Source-Channel Coding of Multimodal Semantic Sources](https://arxiv.org/abs/2605.14334)
...
### [332] [CP-OFDM Achieves Lower Ranging CRB Than Frequency-Spread Waveforms in the Large-Sample Regime](https://arxiv.org/abs/2605.14451)
...
### [333] [LLM-Enabled Automated Algorithm Design for Multiuser Fluid Antenna Communications](https://arxiv.org/abs/2605.14661)
...
### [334] [Construction of Minimal Ternary Linear Codes with Dimension $n+2$](https://arxiv.org/abs/2605.14848)
...
### [335] [GraphBit: A Graph-based Agentic Framework for Non-Linear Agent Orchestration](https://arxiv.org/abs/2605.13848)
...
### [336] [Mixed Integer Goal Programming for Personalized Meal Optimization with User-Defined Serving Granularity](https://arxiv.org/abs/2605.13849)
...
### [337] [A Two-Dimensional Framework for AI Agent Design Patterns: Cognitive Function and Execution Topology](https://arxiv.org/abs/2605.13850)
...
### [338] [Invisible Orchestrators Suppress Protective Behavior and Dissociate Power-Holders: Safety Risks in Multi-Agent LLM Systems](https://arxiv.org/abs/2605.13851)
*Hiroki Fukui*
...
### [339] [PREPING: Building Agent Memory without Tasks](https://arxiv.org/abs/2605.13880)
...
### [340] [PolitNuggets: Benchmarking Agentic Discovery of Long-Tail Political Facts](https://arxiv.org/abs/2605.14002)
*Yifei Zhu*
...
### [341] [Conditional Attribute Estimation with Autoregressive Sequence Models](https://arxiv.org/abs/2605.14004)
...
### [342] [Sheaf-Theoretic Transport and Obstruction for Detecting Scientific Theory Shift in AI Agents](https://arxiv.org/abs/2605.14033)
...
### [343] [Enhanced and Efficient Reasoning in Large Learning Models](https://arxiv.org/abs/2605.14036)
*Leslie G. Valiant*
...
### [344] [Model-Adaptive Tool Necessity Reveals the Knowing-Doing Gap in LLM Tool Use](https://arxiv.org/abs/2605.14038)
...
### [345] [Network-Aware Bilinear Tokenization for Brain Functional Connectivity Representation Learning](https://arxiv.org/abs/2605.14048)
...
### [346] [Bridging Legal Interpretation and Formal Logic: Faithfulness, Assumption, and the Future of AI Legal Reasoning](https://arxiv.org/abs/2605.14049)
...
### [347] [SPIN: Structural LLM Planning via Iterative Navigation for Industrial Tasks](https://arxiv.org/abs/2605.14051)
...
### [348] [Bad Seeing or Bad Thinking? Rewarding Perception for Vision-Language Reasoning](https://arxiv.org/abs/2605.14054)
...
### [349] [MathAtlas: A Benchmark for Autoformalization in the Wild](https://arxiv.org/abs/2605.14061)
...
### [350] [Know When To Fold 'Em: Token-Efficient LLM Synthetic Data Generation via Multi-Stage In-Flight Rejection](https://arxiv.org/abs/2605.14062)
...
### [351] [SkillFlow: Flow-Driven Recursive Skill Evolution for Agentic Orchestration](https://arxiv.org/abs/2605.14089)
...
### [352] [ChromaFlow: A Negative Ablation Study of Orchestration Overhead in Tool-Augmented Agent Evaluation](https://arxiv.org/abs/2605.14102)
*Tarun Mittal*
...
### [353] [Modeling Bounded Rationality in Drug Shortage Pharmacists Using Attention-Guided Dynamic Decomposition](https://arxiv.org/abs/2605.14111)
...
### [354] [ClawForge: Generating Executable Interactive Benchmarks for Command-Line Agents](https://arxiv.org/abs/2605.14133)
...
### [355] [Distribution-Aware Algorithm Design with LLM Agents](https://arxiv.org/abs/2605.14141)
...
### [356] [Agentic Systems as Boosting Weak Reasoning Models](https://arxiv.org/abs/2605.14163)
...
### [357] [Learning Developmental Scaffoldings to Guide Self-Organisation](https://arxiv.org/abs/2605.14998)
...
### [358] [Unsteady Metrics and Benchmarking Cultures of AI Model Builders](https://arxiv.org/abs/2605.14164)
...
### [359] [The Evaluation Trap: Benchmark Design as Theoretical Commitment](https://arxiv.org/abs/2605.14167)
...
### [360] [Grounded Continuation: A Linear-Time Runtime Verifier for LLM Conversations](https://arxiv.org/abs/2605.14175)
...
### [361] [SimPersona: Learning Discrete Buyer Personas from Raw Clickstreams for Grounded E-Commerce Agents](https://arxiv.org/abs/2605.14205)
...
### [362] [ASH: Agents that Self-Hone via Embodied Learning](https://arxiv.org/abs/2605.14211)
...
### [363] [MetaAgent-X : Breaking the Ceiling of Automatic Multi-Agent Systems via End-to-End Reinforcement Learning](https://arxiv.org/abs/2605.14212)
...
### [364] [GenCircuit-RL: Reinforcement Learning from Hierarchical Verification for Genetic Circuit Design](https://arxiv.org/abs/2605.14215)
*Noah Flynn*
...
### [365] [Fusion-fission forecasts when AI will shift to undesirable behavior](https://arxiv.org/abs/2605.14218)
...
### [366] [Good to Go: The LOOP Skill Engine That Hits 99% Success and Slashes Token Usage by 99% via One-Shot Recording and Deterministic Replay](https://arxiv.org/abs/2605.14237)
*Xiaohua Wang,Kai Yu,XuXiao Liang,Liang Wang,Chao Han*
...
### [367] [Hypergraph Enterprise Agentic Reasoner over Heterogeneous Business Systems](https://arxiv.org/abs/2605.14259)
...
### [368] [Heuristic Pathologies and Further Variance Reduction via Uncertainty Propagation in the AIVAT Family of Techniques](https://arxiv.org/abs/2605.14261)
...
### [369] [Agentic AI Ecosystems in Higher Education: A Perspective on AI Agents to Emerging Inclusive, Agentic Multi-Agent AI Framework for Learning, Teaching and Institutional Intelligence](https://arxiv.org/abs/2605.14266)
...
### [370] [Parallelizing Counterfactual Regret Minimization](https://arxiv.org/abs/2605.14277)
*Juho Kim,Tuomas Sandholm*
...
### [371] [Precise Verification of Transformers through ReLU-Catalyzed Abstraction Refinement](https://arxiv.org/abs/2605.14294)
...
### [372] [Semantic Feature Segmentation for Interpretable Predictive Maintenance in Complex Systems](https://arxiv.org/abs/2605.14318)
...
### [373] [Are Agents Ready to Teach? A Multi-Stage Benchmark for Real-World Teaching Workflows](https://arxiv.org/abs/2605.14322)
...
### [374] [CrystalReasoner: Reasoning and RL for Property-Conditioned Crystal Structure Generation](https://arxiv.org/abs/2605.14344)
...
### [375] [Herculean: An Agentic Benchmark for Financial Intelligence](https://arxiv.org/abs/2605.14355)
...
### [376] [Uncovering the Representation Geometry of Minimal Cores in Overcomplete Reasoning Traces](https://arxiv.org/abs/2605.14358)
...
### [377] [Nexus : An Agentic Framework for Time Series Forecasting](https://arxiv.org/abs/2605.14389)
...
### [378] [Learning to Build the Environment: Self-Evolving Reasoning RL via Verifiable Environment Synthesis](https://arxiv.org/abs/2605.14392)
...
### [379] [Coding Agent Is Good As World Simulator](https://arxiv.org/abs/2605.14398)
...
### [380] [Metis AI: The Overlooked Middle Zone Between AI-Native and World-Movers](https://arxiv.org/abs/2605.14407)
*Xiang Li*
...
### [381] [A Unified Knowledge Embedded Reinforcement Learning-based Framework for Generalized Capacitated Vehicle Routing Problems](https://arxiv.org/abs/2605.14416)
...
### [382] [DVMap: Fine-Grained Pluralistic Value Alignment via High-Consensus Demographic-Value Mapping](https://arxiv.org/abs/2605.14420)
...
### [383] [BEAM: Binary Expert Activation Masking for Dynamic Routing in MoE](https://arxiv.org/abs/2605.14438)
...
### [384] [Synthesizing POMDP Policies: Sampling Meets Model-checking via Learning](https://arxiv.org/abs/2605.14440)
...
### [385] [Prompting Policies for Multi-step Reasoning and Tool-Use in Black-box LLMs with Iterative Distillation of Experience](https://arxiv.org/abs/2605.14443)
...
### [386] [Intelligence Impact Quotient (IIQ): A Framework for Measuring Organizational AI Impact](https://arxiv.org/abs/2605.14455)
...
### [387] [Stateful Reasoning via Insight Replay](https://arxiv.org/abs/2605.14457)
...
### [388] [OmniDrop: Layer-wise Token Pruning for Omni-modal LLMs via Query-Guidance](https://arxiv.org/abs/2605.14458)
...
### [389] [From Table to Cell: Attention for Better Reasoning with TABALIGN](https://arxiv.org/abs/2605.14465)
...
### [390] [Deepchecks: Evaluating Retrieval-Augmented Generation (RAG)](https://arxiv.org/abs/2605.14488)
...
### [391] [Learning Scenario Reduction for Two-Stage Robust Optimization with Discrete Uncertainty](https://arxiv.org/abs/2605.14494)
...
### [392] [When Robots Do the Chores: A Benchmark and Agent for Long-Horizon Household Task Execution](https://arxiv.org/abs/2605.14504)
...
### [393] [Cattle Trade: A Multi-Agent Benchmark for LLM Bluffing, Bidding, and Bargaining](https://arxiv.org/abs/2605.14537)
...
### [394] [VerbalValue: A Socially Intelligent Virtual Host for Sales-Driven Live Commerce](https://arxiv.org/abs/2605.14542)
*Yuyan Chen*
...
### [395] [Complacent, Not Sycophantic: Reframing Large Language Models and Designing AI Literacy for Complacent Machines](https://arxiv.org/abs/2605.14544)
...
### [396] [TeachAnything: A Multimodal Crowdsourcing Platform for Training Embodied AI Agents in Symmetrical Reality](https://arxiv.org/abs/2605.14556)
...
### [397] [PyCSP3-Scheduling: A Scheduling Extension for PyCSP3](https://arxiv.org/abs/2605.14559)
*Sohaib Afifi*
...
### [398] [Prompt Segmentation and Annotation Optimisation: Controlling LLM Behaviour via Optimised Segment-Level Annotations](https://arxiv.org/abs/2605.14561)
...
### [399] [Sycophancy is an Educational Safety Risk: Why LLM Tutors Need Sycophancy Benchmarks](https://arxiv.org/abs/2605.14604)
...
### [400] [SliceGraph: Mapping Process Isomers in Multi-Run Chain-of-Thought Reasoning](https://arxiv.org/abs/2605.14619)
...
### [401] [Teaching Large Language Models When Not to Know: Learning Temporal Critique for Ex-Ante Reasoning](https://arxiv.org/abs/2605.14636)
...
### [415] [Emotion-Attended Stateful Memory (EASM):The Architecture for Hyper-Personalization at Scale](https://arxiv.org/abs/2605.14833)
...
### [416] [A Deterministic Agentic Workflow for HS Tariff Classification: Multi-Dimensional Rule Reasoning with Interpretable Decisions](https://arxiv.org/abs/2605.14857)
...
### [417] [Holistic Evaluation and Failure Diagnosis of AI Agents](https://arxiv.org/abs/2605.14865)
...
### [418] [BiFedKD: Bidirectional Federated Knowledge Distillation Framework for Non-IID and Long-Tailed ECG Monitoring](https://arxiv.org/abs/2605.14886)
...
### [419] [Beyond Individual Intelligence: Surveying Collaboration, Failure Attribution, and Self-Evolution in LLM-based Multi-Agent Systems](https://arxiv.org/abs/2605.14892)
...
### [420] [COREKG: Coreset-Guided Personalized Summarization of Knowledge Graphs](https://arxiv.org/abs/2605.14900)
...
### [421] [KGPFN: Unlocking the Potential of Knowledge Graph Foundation Model via In-Context Learning](https://arxiv.org/abs/2605.14907)
...
### [422] [From Sycophantic Consensus to Pluralistic Repair: Why AI Alignment Must Surface Disagreement](https://arxiv.org/abs/2605.14912)
...
### [423] [GraphFlow: An Architecture for Formally Verifiable Visual Workflows Enabling Reliable Agentic AI Automation](https://arxiv.org/abs/2605.14968)
...
### [424] [Explainable Detection of Depression Status Shifts from User Digital Traces](https://arxiv.org/abs/2605.14995)
...
### [425] [Small, Private Language Models as Teammates for Educational Assessment Design](https://arxiv.org/abs/2605.15015)
...
### [426] [Orchard: An Open-Source Agentic Modeling Framework](https://arxiv.org/abs/2605.15040)
...
### [427] [Case-Based Calibration of Adaptive Reasoning and Execution for LLM Tool Use](https://arxiv.org/abs/2605.15041)
...
### [428] [Dual-Dimensional Consistency: Balancing Budget and Quality in Adaptive Inference-Time Scaling](https://arxiv.org/abs/2605.15100)
...
### [429] [Why Neighborhoods Matter: Traversal Context and Provenance in Agentic GraphRAG](https://arxiv.org/abs/2605.15109)
...
### [430] [APWA: A Distributed Architecture for Parallelizable Agentic Workflows](https://arxiv.org/abs/2605.15132)
...
### [431] [OpenDeepThink: Parallel Reasoning via Bradley--Terry Aggregation](https://arxiv.org/abs/2605.15177)
